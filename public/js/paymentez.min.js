"use strict";function PaymentezForm(elem){
    ...
    this.cardType="",
        ...
        this.nip="",
        this.USE_OTP=!1,
        /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?this.USE_VIRTUAL_KEYBOARD=!1:this.USE_VIRTUAL_KEYBOARD=!0,
...
(jQuery),$(function(){
    $(".paymentez-form").not(".checkout").each(function(i,obj){$(obj).PaymentezForm()
    })
}),
PaymentezForm.prototype.constructor=PaymentezForm,
PaymentezForm.KEYS={0:48,9:57,NUMPAD_0:96,NUMPAD_9:105,DELETE:46,BACKSPACE:8,ARROW_LEFT:37,ARROW_RIGHT:39,ARROW_UP:38,ARROW_DOWN:40,HOME:36,END:35,TAB:9,A:65,X:88,C:67,V:86},
...
PaymentezForm.CREDIT_CARD_NUMBER_PLACEHOLDER="NÃºmero de tarjeta",
...
PaymentezForm.FISCAL_NUMBER_PLACEHOLDER="Documento de IdentificaciÃ³n",
...
PaymentezForm.keyIsArrow=function(e){
    var keyCode=PaymentezForm.keyCodeFromEvent(e);return keyCode>=PaymentezForm.KEYS.ARROW_LEFT&&keyCode<=PaymentezForm.KEYS.ARROW_DOWN
},
PaymentezForm.keyIsNavigation=function(e){
    var keyCode=PaymentezForm.keyCodeFromEvent(e);return keyCode==PaymentezForm.KEYS.HOME||keyCode==PaymentezForm.KEYS.END
},
...
Paymentez.uuidv4=function(){
    return"xxxxxxxxxxxx4xxxyxxxxxxxxxxxxxxx".replace(/[xy]/g,function(c){
        var r=16*Math.random()|0;return("x"==c?r:3&r|8).toString(16)})
},
...
Paymentez.createToken=function(createTokenRequest,successCallback,erroCallback){
    var SERVER_URL=this.getServerURL(), xmlhttp=new XMLHttpRequest;

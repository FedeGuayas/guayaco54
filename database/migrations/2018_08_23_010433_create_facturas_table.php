...
class CreateFacturasTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('facturas', function (Blueprint $table) {
            ...
            $table->integer('total');//valor incluido descuentos descuento
            ...
            $table->string('status')->default(\App\Factura::ACTIVA);//Pendiente:no se ha pagado,Pagada: se pago y genera num corredor,

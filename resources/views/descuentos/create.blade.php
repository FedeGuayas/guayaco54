...
@section('page_title','Crear descuento')

@section('breadcrumbs')
    {!! Breadcrumbs::render('descuento-create') !!}
@endsection
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Nuevo Descuento</h5>
            </div>
        </div>

        {!! Form::open(['route' => 'descuentos.store', 'method' => 'post', 'autocomplete'=> 'off', 'class'=>'','id'=>'form' ]) !!}
        <div class="row">
...
<script src="{{asset('themes/back/src/plugins/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.js')}}"></script>

...
@section('content')
    ...
    <div class="pd-20 mt-15 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="form-group row">
            <label for="server_app_code" class="col-sm-12 col-md-2 col-form-label weight-600">Server App Code</label>
            <div class="col-sm-12 col-md-6">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-6">
                {!! Form::text('server_app_key',isset($config->server_app_key) ? $config->server_app_key : null,['class'=>'form-control','placeholder'=>'server-app-key paymentez']) !!}
            </div>
        </div>
        <div class="form-group row">

...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Crear Cliente</h5>
            </div>
        </div>
        {!! Form::open(['route' => 'admin.cliente.store', 'method' => 'post', 'autocomplete'=> 'off', 'class'=>'form_noEnter','id'=>'form-store' ]) !!}
        ...
        <div class="row">
            <div class="form-group col-md-4 col-sm-12">
                ...
                {!! Form::text('fecha_nac',null,['class'=>'form-control date-picker','onkeydown'=>'return false;','value'=>'{{ old("fecha_nac") }}','required']) !!}
            </div>
            <div class="form-group col-md-4 col-sm-12">

...
@section('page_title','Crear Perfil Asociado')
@section('breadcrumbs')
    {!! Breadcrumbs::render('perfil-as-create') !!}
@stop
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix">
            ...
            <p class="mb-30 font-14">Para crear un perfil para un amigo al que podrá inscribir en la carrera a través de su cuenta</p>
        </div>

        <div class="wizard-content">
            {!! Form::open(['route' => 'perfil-asociado.store.new', 'method' => 'post', 'autocomplete'=> 'off', 'class'=>'tab-wizard wizard-circle wizard','id'=>'form-wizard' ]) !!}
            ...
            <section>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Email :</label>
                            {!! Form::email('email',null,['class'=>'form-control required','placeholder'=>'Email','style'=>'text-transform: lowercase','value'=>'{{ old("email") }}','required']) !!}

                    ...
                    @if(!$circuitos->isEmpty())
                        @foreach ($circuitos as $cir)
                            <div class="custom-control custom-radio mb-5">
                                <input type="radio" id="{{$cir->id}}" name="circuito"
                                       class="custom-control-input" value="{{$cir->id}}"
                                       @if( $producto->circuito_id==$cir->id) checked @endif>
                                <label class="custom-control-label"
                                       for="{{$cir->id}}">{{ ucfirst($cir->circuito)}}</label>
                            </div>
                        @endforeach
                    @endif
                </div>

...
@section('page_title','Crear deporte')

@section('breadcrumbs')
    {!! Breadcrumbs::render('deporte-create') !!}
@endsection
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Nuevo deporte</h5>
            </div>
        </div>

        {!! Form::open(['route' => 'deportes.store', 'method' => 'post', 'autocomplete'=> 'off','id'=>'form' ]) !!}
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">Deporte del corredor que se inscribirá como deportista.</small>
                </div>
            </div>
        </div>

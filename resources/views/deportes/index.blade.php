...
@section('page_title','Deportes')

@section('breadcrumbs')
    {!! Breadcrumbs::render('deporte') !!}
@stop
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Todos los Deportes</h5>
                <p class="font-14">para crear uno nuevo <a class="btn btn-sm btn-outline-primary" href="{{route('deportes.create')}}">
        ...
        <div class="row">
            <table class="data-table stripe hover nowrap compact">
                <thead>
                <tr>
                    <th class="datatable-nosort">Deporte</th>
                    <th>Estado</th>
                ...
                <tr>
                    <td class="dt-nosort">{{$dep->deporte}}</td>
                    <td>
                        @if ($dep->status==\App\Deporte::ACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_deporte" href="#" data-id="{{$dep->id}}"><i class="fa fa-check-square-o text-danger"></i> Deshabilitar</a>
                                </div>
                            </div>
                            @elseif($dep->status==\App\Deporte::INACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_deporte" href="#" data-id="{{$dep->id}}"><i class="fa fa-check-square-o text-danger"></i> Habilitar</a>
                                </div>
                            </div>
                        @endif
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{route('deportes.edit',$dep->id)}}"><i class="fa fa-pencil text-success"></i> Editar</a>
                            </div>
                        </div>
                    </td>
                </tr>
@endforeach
    ...
    {!! Form::open(['route'=>['deportes.set.status',':ID'],'method'=>'post','id'=>'form-status']) !!}
    {!! Form::close() !!}
...
<script>
    ...
    $(document).on('click', '.status_deporte', function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            text: "Se Habilitará/Dashabilitará el deporte según corresponda!",
            type: 'warning',

...
@section('page_title','Circuitos')

@section('breadcrumbs')
    {!! Breadcrumbs::render('circuito') !!}
@stop
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="row">
            <table class="data-table stripe hover nowrap compact">
                <thead>
                <tr>
                    <th class="datatable-nosort">Circuito</th>
                    <th>Nombre</th>
                    <th>Estado</th>
                ...
                @foreach($circuitos as $c)
                    <tr>
                        <td class="dt-nosort">{{$c->circuito}}</td>
                        <td>{{$c->title}}</td>
                        <td>
                            @if ($c->status==\App\Circuito::ACTIVO)
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item status_circuito" href="#" data-id="{{$c->id}}"><i
                                                    class="fa fa-check-square-o text-danger"></i> Deshabilitar</a>
                                    </div>
                                </div>
                            @elseif($c->status==\App\Circuito::INACTIVO)
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item status_circuito" href="#" data-id="{{$c->id}}"><i
                                                    class="fa fa-check-square-o text-danger"></i> Habilitar</a>
                                    </div>
                                </div>
                            @endif
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{route('circuitos.edit',$c->id)}}"><i

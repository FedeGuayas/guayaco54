...
@section('breadcrumbs')
    {!! Breadcrumbs::render('talla-edit',$talla) !!}
@endsection
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Editar Talla</h5>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::select('color', ['NEGRA'=> 'NEGRA', 'BLANCA' => 'BLANCA','FUCSIA'=>'FUCSIA','AZUL'=>'AZUL','NARANJA'=>'NARANJA','CELESTE'=>'CELESTE'],$talla->color, ['class'=>'form-control','required']) !!}
                </div>
            </div>
        </div>
        <div class="row">

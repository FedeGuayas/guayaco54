...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Todas las Categorías</h5>
                <p class="font-14">para crear una nueva <a class="btn btn-sm btn-outline-primary" href="{{route('categorias.create')}}">
        ...
        <div class="row">
            <table class="data-table stripe hover nowrap compact">
                ...
                <tr>
                    ...
                    <td>{{$cat->edad_end}}</td>
                    <td>
                        @if ($cat->status==\App\Categoria::ACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_categoria" href="#" data-id="{{$cat->id}}"><i class="fa fa-check-square-o text-danger"></i> Deshabilitar</a>
                                </div>
                            </div>
                            @elseif($cat->status==\App\Categoria::INACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_categoria" href="#" data-id="{{$cat->id}}"><i class="fa fa-check-square-o text-danger"></i> Habilitar</a>
                                </div>
                            </div>
                        @endif
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{route('categorias.edit',$cat->id)}}"><i class="fa fa-pencil text-success"></i> Editar</a>
                            </div>
                        </div>
                    </td>
                </tr>
@endforeach
    ...
    {!! Form::open(['route'=>['categorias.set.status',':ID'],'method'=>'post','id'=>'form-status']) !!}
    {!! Form::close() !!}
...
<script>
    ...
    $(document).on('click', '.status_categoria', function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            text: "Se Habilitará/Dashabilitará la categoría según corresponda!",
            type: 'warning',

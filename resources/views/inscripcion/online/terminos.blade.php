...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <h4 class="modal-title text-red-50" id="termModalLabel">Condiciones de inscripción online a la Carrera
            Guayaco
            Runner</h4>
        ...
        <dl>
            ...
            <li>
                Los kits sólo pueden ser retirados el día sábado 17 de noviembre a partir de las 09h00 am hasta

<div class="modal fade" id="terminos-modal" tabindex="-1" role="dialog" aria-labelledby="termModalLabel"
     aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style=" width: 70% !important;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-red-50" id="termModalLabel">Condiciones de inscripción online a la Carrera
                    Guayaco
                    Runner</h5>
            ...
            <div class="modal-body" style="font-size: 12px; font-weight: 500;">

                <h5 class="text-blue-50">Términos y condiciones de inscripción a la Carrera Guayaco Runner V edición
                    (2018) </h5>
                <p>

                <dl>
                    <li>
                        Este sistema es exclusivamente para inscripción y pago del registro en la carrera Guayaco Runner
                        V edición.
                    </li>
                    <li>
                    ...
                    <li>
                        Los kits sólo pueden ser retirados el día sábado 27 de octubre a partir de las 09h00 am hasta
                    ...
                    <li>
                        Las personas con discapacidad y/ó tercera edad que deseen acceder al 50% de descuento, deberán
                ...
                <h5 class="text-blue-50">Medios de pago</h5>
                <p>
                <dl>
                    <li>
                ...
                <h5 class="text-blue-50">Derecho de retracto y devoluciones</h5>
                <p>
                <dl>
                    <li>

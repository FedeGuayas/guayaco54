            ...
            <table class="table table-bordered table-striped">
                ...
                @foreach ($roles as $role)
                    <tr>
                        ...
                        <td>{{ str_replace(['[',']','"'],'', $role->permissions()->pluck('name')) }}</td>{{-- Retrieve array of permissions associated to a role and convert to string --}}
                        <td>
                            <a href="{{ route('roles.edit',$role) }}" class="btn btn-info pull-left" style="margin-right: 3px;">Edit</a>

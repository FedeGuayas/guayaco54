...
@section('page_title','Escenarios')

@section('breadcrumbs')
    {!! Breadcrumbs::render('escenario') !!}
@stop
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Todos los Escenarios</h5>
                <p class="font-14">para crear uno nuevo <a class="btn btn-sm btn-outline-primary" href="{{route('escenarios.create')}}">
        ...
        <div class="row">
            <table class="data-table stripe hover nowrap compact">
                <thead>
                <tr>
                    <th class="datatable-nosort">Escenario</th>
                    <th>Estado</th>
                ...
                <tr>
                    <td class="dt-nosort">{{$esc->escenario}}</td>
                    <td>
                        @if ($esc->status==\App\Escenario::ACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_escenario" href="#" data-id="{{$esc->id}}"><i class="fa fa-check-square-o text-danger"></i> Deshabilitar</a>
                                </div>
                            </div>
                            @elseif($esc->status==\App\Escenario::INACTIVO)
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item status_escenario" href="#" data-id="{{$esc->id}}"><i class="fa fa-check-square-o text-danger"></i> Habilitar</a>
                                </div>
                            </div>
                        @endif
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a class="dropdown-item" href="{{route('escenarios.edit',$esc->id)}}"><i class="fa fa-pencil text-success"></i> Editar</a>
                            </div>
                        </div>
                    </td>
                </tr>
@endforeach
    ...
    {!! Form::open(['route'=>['escenarios.set.status',':ID'],'method'=>'post','id'=>'form-status']) !!}
    {!! Form::close() !!}
...
<script>
    ...
    $(document).on('click', '.status_escenario', function (e) {
        e.preventDefault();
        ...
        swal({
            ...
            text: "Se Habilitará/Dashabilitará el escenario según corresponda!",
            type: 'warning',

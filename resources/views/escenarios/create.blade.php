...
@section('page_title','Crear escenario')

@section('breadcrumbs')
    {!! Breadcrumbs::render('escenario-create') !!}
@endsection
...
@section('content')
    ...
    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
        ...
        <div class="clearfix mb-20">
            <div class="pull-left">
                <h5 class="text-blue">Nuevo Escenario de inscripción</h5>
            </div>
        </div>

        {!! Form::open(['route' => 'escenarios.store', 'method' => 'post', 'autocomplete'=> 'off', 'class'=>'','id'=>'form' ]) !!}
        <div class="row">
